<tr class="tbdetail">
  ...
  <input type="hidden" name="karyawanid_hidden[]" value="<?= $this->input->post('idkaryawan') ?>">
  ...
  <td class="action">
    <button type="button" class="btn btn-danger" id="btn-hapus-um" data-toggle="tooltip" title="Hapus Penerima" data-nama="<?= $this->input->post('nama') ?>">
