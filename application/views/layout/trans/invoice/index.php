      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <div class="breadcrumb float-sm-right">
            <a href="<?= base_url('invoice/add') ?>" class="btn btn-dark border border-light">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="padding: 1rem 2rem !important;">
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
          <div>
            <p class="text-uppercase mb-0 noinv"></p>
        ...
        <div class="table-responsive">
          <table class="table table-bordered" width="100%" cellspacing="0">
            <thead class="text-center" style="border:1.5px solid rgb(145, 143, 143) !important;">
              ...
              <th class="align-middle" style="border-color: rgb(145, 143, 143) !important;">Reccu</th>
